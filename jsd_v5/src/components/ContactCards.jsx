      ...
      <div className="grid grid-cols-2 gap-6 place-items-center">
        ...
        >
          <GlassSurface
            ...
            borderRadius={24}
          >
            <div className="flex flex-col items-center justify-center text-center w-full h-full cursor-pointer">
              <div className="flex flex-row items-center justify-center gap-2 mb-2">
                <img
                  src={behanceLogo}
                  alt="Behance"
                  className="w-7 h-7 filter invert brightness-90 opacity-80"
                />
        ...
        {/* Instagram */}
        <a
          href="https://www.instagram.com/jsdglobaldesign?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
          target="_blank"
          rel="noopener noreferrer"
          className="no-underline"
        >
        ...
        {/* Mail */}
        <a
          href="mailto:joevinsirach@gmail.com"
          className="no-underline"
        >
          <GlassSurface
            width={220}
